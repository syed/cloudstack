...
# on June 9, 2016: Ran 11 tests in 2363.899s with two hosts (resign = True)
# on June 9, 2016: Ran 11 tests in 2071.610s with two hosts (resign = False)
...
class TestVolumes(cloudstackTestCase):
    ...
    def _check_xen_sr(self, xen_sr_name, should_exist=True):
        if should_exist:
            ...
            sf_util.check_list(xen_sr, 0, self, TestVolumes._list_should_be_empty)
