...
public final class CitrixDeleteStoragePoolCommandWrapper extends CommandWrapper<DeleteStoragePoolCommand, Answer, XenServerResourceBase> {
    ...
    public Answer execute(final DeleteStoragePoolCommand command, final XenServerResourceBase xenServerResourceBase) {
        ...
        try {
            ...
            final String msg = "DeleteStoragePoolCommand XenAPIException:" + e.getMessage() + " host:" + xenServerResourceBase.getHost().getUuid() + " pool: " + poolTO.getHost()
                    + poolTO.getPath();
            s_logger.warn(msg, e);
