...
public final class CitrixClusterVMMetaDataSyncCommandWrapper extends CommandWrapper<ClusterVMMetaDataSyncCommand, Answer, XenServerResourceBase> {

    private static final Logger s_logger = Logger.getLogger(CitrixClusterVMMetaDataSyncCommandWrapper.class);

    @Override
    public Answer execute(final ClusterVMMetaDataSyncCommand command, final XenServerResourceBase xenServerResourceBase) {
        ...
        try {
            ...
            if (!xenServerResourceBase.getHost().getUuid().equals(hostr.uuid)) {
        ...
        final HashMap<String, String> vmMetadatum = xenServerResourceBase.clusterVMMetaDataSync(conn);
